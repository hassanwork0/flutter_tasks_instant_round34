...
import 'package:r34_16/src/features/entrypoint/domain/usecases/top_viewed_usecase.dart';
...
class PopularPacks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topViewedUseCase = TopViewedUseCase(repo);
    ...
    return FutureBuilder<List<ProductEntity>>(
      ...
      builder: (context, snapshot) {
        ...
        final products = topViewedUseCase(snapshot.data!);
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => print('View All Popular Packs'),
                    child: const Text(
                      'View All',
